...
use crate::types::{ContentBlock, Protocol, StopReason};
...
/// 将 genai StopReason 转换为本地 StopReason。
pub fn stop_reason_from_genai(r: &genai::chat::StopReason) -> StopReason {
    match r {
        ...
        genai::chat::StopReason::ContentFilter(_) => StopReason::ContentFilter,
        genai::chat::StopReason::StopSequence(_) => StopReason::StopSequence,
        genai::chat::StopReason::Other(s) => StopReason::Other(s.clone()),
    }
}
